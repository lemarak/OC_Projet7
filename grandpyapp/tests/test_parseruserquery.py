...
class TestParseQuery:
    ...
    def test_slugify(self):
        ...
        text_slugify = parser_query._slugify_text(parser_query.text_to_parse)
    ...
    def test_delete_expression_with_true(self):
        ...
        parser_query._delete_expression(self.QUERY_TO_DELETE, True)
